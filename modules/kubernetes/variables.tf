...
variable "k8s_security_group_name" {
  description = "The name of the k8s NSG created in Azure"
}
...
variable "kubeadm_token" {
  description = "Bootstrap token derived from kubeadm-token module"
}

variable "cloudconfig_masters_file" {
  description = "The location of the cloud init configuration file."
  default     = "./modules/scripts/cloud-init-master.sh"
}

variable "cloudconfig_agent_file" {
  description = "The location of the cloud init configuration file."
  default     = "./modules/scripts/cloud-init-agent.sh"
}
